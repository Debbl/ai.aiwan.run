    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 24 24' {...props}>
      <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
          ...
          strokeLinejoin='round'
        ></path>
        <path d='M12 2V22' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'></path>
        <path d='M2.50738 15.9871H11.1437' stroke='currentColor' strokeWidth='2' strokeLinecap='round'></path>
      </svg>
    </svg>
  )
}
