...
import { Button, DatePicker, Select, SelectItem, Skeleton, Spinner } from '@heroui/react'
    ...
    <div className='relative flex min-h-screen flex-col items-center'>
      ...
      {reasoning && (
        <div className='mx-auto w-[600px] max-w-full px-3 pt-8'>
          ...
          {isShowThinking && (
            <div className={cn('prose dark:prose-invert bg-background mt-2 rounded-md p-2')}>
      ...
      <div className='fixed inset-x-0 bottom-4'>
        <Skeleton
          ...
          classNames={{
            ...
            content: 'flex mx-auto flex-col items-center justify-center gap-2 rounded-md md:bottom-8 md:flex-row',
          }}
        >
          ...
          <div className='flex w-full items-center justify-center gap-x-2 md:w-auto'>
            ...
            <div className='bg-background'>
              <CopyButton isDisabled={!message || status !== 'ready'} code={message.content} />
            </div>
          </div>
        </Skeleton>
      </div>
